...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"code in iphone4";


    [WWFrame RegisterDeviceType:EditingDeviceTypeIphone4];
    ...
    UILabel *leftDown = [[UILabel alloc]initWithFrame:[WWFrame FrameWithX:0 Y:380 Width:100 Height:100]];
    leftDown.backgroundColor = [UIColor greenColor];
    [self.view addSubview:leftDown];
    
    UILabel *rightDown = [[UILabel alloc]initWithFrame:[WWFrame FrameWithX:220 Y:380 Width:100 Height:100]];
